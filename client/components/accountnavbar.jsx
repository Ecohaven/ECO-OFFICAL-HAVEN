...
import '../src/App.css';
import { Box, Container, AppBar, Toolbar, Typography, Button, Icon, IconButton, Popover, Input, 
  List, ListItem, ListItemText, Divider, Drawer } from '@mui/material';
            ...
            <Toolbar disableGutters={true}>
              ...
              <Box sx={{ display: 'flex', flexGrow: 1, alignItems: 'center' }}>
                ...
                <Link to="/" style={{ textDecoration: 'none', margin: '0.5rem' }}>
                  <Typography variant="h5" component="div" id='home_link' sx={{ fontWeight: 'bold', fontSize: { xs: '1.5rem', sm: '1.7rem', md: '2rem' },
